...
Proof.
  intros n. induction n as [| n' IHn'].
    ...
    - intros m H. destruct m as [|m']eqn:E.
      + discriminate H.
      + f_equal. apply S_inj in H. apply IHn'. apply H.
Qed. 
(** [] *)
...
Proof.
  ...
  - intros m eq. destruct m as [|m'] eqn:E.
    + discriminate eq.
    + f_equal. apply IHn'. simpl in eq. rewrite <- plus_n_Sm in eq.
      rewrite <- plus_n_Sm in eq. injection eq as H. apply H.
 Qed.
(** [] *)
...
Proof.
  ...
  - intros n eq. destruct n as [|n']eqn:E.
    + discriminate eq.  
    + simpl. apply IHl'. simpl in eq. injection eq as goal.
      apply goal.
Qed.
